...
const Navbar = () => {
  ...
  md:rounded-2xl max-md:rounded-b-3xl backdrop-blur bg-black/70 md:bg-white/10 md:border
  border-gray-300/20 overflow-hidden transition-[width] duration-300'>

  <XIcon className='md:hidden absolute top-6 right-6 w-6 h-6 cursor-pointer text-white' />
  ...
  <Link to='/favorite'> Favourites</Link>
      ...
      <div className='flex items-center gap-8'>
       ...
       transition rounded-full fot-medium cursor-pointer'>Login</button>
